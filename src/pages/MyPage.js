    ...
    <div className="scroll-container">
      ...
      <div className="card-scroll-area">
        {flights.map((flight) => (
          <div
            key={flight.id}
            className={`card-container ${flippedCards[flight.id] ? 'flipped' : ''}`}
            onClick={() => toggleFlip(flight.id)}
          >
            <div className="card">
              <div className="card-front" style={{ backgroundImage: `url(${flight.pic})` }}>
                <div className="flight-codes">{flight.DepartureCode} -> {flight.ArrivalCode}</div>
        ...
        <div className="modal">
          <div className="modal-content">
            ...
            <input
              ...
              onChange={(e) => setEditData({ ...editData, DepartureCode: e.target.value })}
            />
            <label>Arrival Code</label>
            <input
              type="text"
              value={editData.ArrivalCode}
              onChange={(e) => setEditData({ ...editData, ArrivalCode: e.target.value })}
            />
            <label>Airline Name</label>
            <input
              type="text"
              value={editData.AirlineName}
              onChange={(e) => setEditData({ ...editData, AirlineName: e.target.value })}
            />
